...
import { BiAlignRight, BiCart, BiLayer, BiLockAlt, BiMailSend, BiMessageSquareEdit, BiNotepad, BiUser, BiUserPin } from 'react-icons/bi';
    ...
    return (
        <div className="col-span-3 font-poppins">
            ...
            <div className='bg-white shadow px-4 py-3 flex items-center justify-between'>
                ...
                <div>
                    <button onClick={toggleSidebar}><BiAlignRight size={20} /></button>
                </div>
            </div>
            {/* <!-- account profile end --> */}
